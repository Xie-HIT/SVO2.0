...
struct InitializationOptions
{
  ...
  /// is good.
  double init_min_disparity = 50.0; // 初始化前两帧间的视差，越大对三角化越有利
  ...
  size_t init_min_features = 100; // 首帧至少需要有的特征点数量
  ...
  size_t init_min_inliers = 40; // 初始化成功至少需要的内点数量
